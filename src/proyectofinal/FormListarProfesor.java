 ...
 * @author User
 */
public class FormListarProfesor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTAR PROFESORES AGREGADOS");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 490, -1));

        lstAlumno.setFont(new java.awt.Font("Yu Gothic UI", 0, 14)); // NOI18N
        jScrollPane1.setViewportView(lstAlumno);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, 490, 530));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/FondoListar2.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormListarProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private String[] convertirCadena() {   
        String[] x = new String[repo.listarProfesor().size()];
        
        for(int i=0;i<repo.listarProfesor().size();i++){
            if(repo.listarProfesor().get(i).getEstadoProfesor()==1&&repo.listarProfesor().get(i).getCodProfesor()!=1){
            String nameCurso = repo.obtenerCurso(repo.listarProfesor().get(i));
            x[i] = "(" + repo.listarProfesor().get(i).getCodProfesor() + ")     " + repo.listarProfesor().get(i).getNameProfesor() + ", " 
                    + repo.listarProfesor().get(i).getApellidoProfesor() + "    -   " + nameCurso;                
            }
        }
        return x;
    }
